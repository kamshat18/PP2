...
class Snake:
    def __init__(self):
        self.body = [(100, 100), (80, 100), (60, 100)]  # начальное положение тела змеи
...
class Food:
    ...
    def respawn(self, snake_body):
        self.position = self.generate_position(snake_body)  # респаун новой еды
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_UP:
                snake.change_direction((0, -CELL_SIZE))  # движение вверх
            elif event.key == pygame.K_DOWN:
                snake.change_direction((0, CELL_SIZE))  # движение вниз
            elif event.key == pygame.K_LEFT:
                snake.change_direction((-CELL_SIZE, 0))  # движение влево
            elif event.key == pygame.K_RIGHT:
                snake.change_direction((CELL_SIZE, 0))  # движение вправо
